            ...
            <aside
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <div className='my-0 md:my-4 text-right md:text-center'>
                        ...
                        <p className='text-left'>Go to <Link href={'http://bayufadayan.my.id'} className='text-blue-400 font-semibold hover:underline hover:text-blue-500'>bayufadayan.my.id</Link></p>
                    </div>
